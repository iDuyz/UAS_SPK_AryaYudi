...
class BaseMethod():
    ...
    def data(self):
        ...
        return [{'id': smartphonepoco.id, 
        'brand': DEV_SCALE_bran[smartphonepoco.brand], 
        'ram': DEV_SCALE_ram[smartphonepoco.ram], 
        'prosesor': DEV_SCALE_prosesor[smartphonepoco.prosesor], 
        'storage': DEV_SCALE_storage[smartphonepoco.storage], 
        'baterai': DEV_SCALE_baterai[smartphonepoco.baterai], 
        'ukuran_layar': DEV_SCALE_ukuran_layar[smartphonepoco.ukuran_layar], 
        'harga': DEV_SCALE_harga[smartphonepoco.harga]} for smartphonepoco in session.scalars(query)]
